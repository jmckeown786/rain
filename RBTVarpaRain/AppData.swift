...
enum AppData {
    static let sportTeams: [SportTeam] = [
        SportTeam(id: "pl-afc-bournemouth", name: "AFC Bournemouth", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-arsenal", name: "Arsenal", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-aston-villa", name: "Aston Villa", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-brentford", name: "Brentford", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-brighton", name: "Brighton & Hove Albion", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-burnley", name: "Burnley", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-chelsea", name: "Chelsea", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-crystal-palace", name: "Crystal Palace", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-everton", name: "Everton", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-fulham", name: "Fulham", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-leeds", name: "Leeds United", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-liverpool", name: "Liverpool", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-man-city", name: "Manchester City", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-man-united", name: "Manchester United", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-newcastle", name: "Newcastle United", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-nottingham", name: "Nottingham Forest", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-sunderland", name: "Sunderland", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-tottenham", name: "Tottenham Hotspur", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-west-ham", name: "West Ham United", league: "Premier League", region: "England", sport: .football),
        SportTeam(id: "pl-wolves", name: "Wolverhampton Wanderers", league: "Premier League", region: "England", sport: .football),

        SportTeam(id: "nba-atlanta", name: "Atlanta Hawks", league: "NBA", region: "Southeast", sport: .basketball),
        SportTeam(id: "nba-boston", name: "Boston Celtics", league: "NBA", region: "Atlantic", sport: .basketball),
        SportTeam(id: "nba-brooklyn", name: "Brooklyn Nets", league: "NBA", region: "Atlantic", sport: .basketball),
        SportTeam(id: "nba-charlotte", name: "Charlotte Hornets", league: "NBA", region: "Southeast", sport: .basketball),
        SportTeam(id: "nba-chicago", name: "Chicago Bulls", league: "NBA", region: "Central", sport: .basketball),
        SportTeam(id: "nba-cleveland", name: "Cleveland Cavaliers", league: "NBA", region: "Central", sport: .basketball),
        SportTeam(id: "nba-dallas", name: "Dallas Mavericks", league: "NBA", region: "Southwest", sport: .basketball),
        SportTeam(id: "nba-denver", name: "Denver Nuggets", league: "NBA", region: "Northwest", sport: .basketball),
        SportTeam(id: "nba-detroit", name: "Detroit Pistons", league: "NBA", region: "Central", sport: .basketball),
        SportTeam(id: "nba-golden-state", name: "Golden State Warriors", league: "NBA", region: "Pacific", sport: .basketball),
        SportTeam(id: "nba-houston", name: "Houston Rockets", league: "NBA", region: "Southwest", sport: .basketball),
        SportTeam(id: "nba-indiana", name: "Indiana Pacers", league: "NBA", region: "Central", sport: .basketball),
        SportTeam(id: "nba-clippers", name: "LA Clippers", league: "NBA", region: "Pacific", sport: .basketball),
        SportTeam(id: "nba-lakers", name: "Los Angeles Lakers", league: "NBA", region: "Pacific", sport: .basketball),
        SportTeam(id: "nba-memphis", name: "Memphis Grizzlies", league: "NBA", region: "Southwest", sport: .basketball),
        SportTeam(id: "nba-miami", name: "Miami Heat", league: "NBA", region: "Southeast", sport: .basketball),
        SportTeam(id: "nba-milwaukee", name: "Milwaukee Bucks", league: "NBA", region: "Central", sport: .basketball),
        SportTeam(id: "nba-minnesota", name: "Minnesota Timberwolves", league: "NBA", region: "Northwest", sport: .basketball),
        SportTeam(id: "nba-new-orleans", name: "New Orleans Pelicans", league: "NBA", region: "Southwest", sport: .basketball),
        SportTeam(id: "nba-new-york", name: "New York Knicks", league: "NBA", region: "Atlantic", sport: .basketball),
        SportTeam(id: "nba-okc", name: "Oklahoma City Thunder", league: "NBA", region: "Northwest", sport: .basketball),
        SportTeam(id: "nba-orlando", name: "Orlando Magic", league: "NBA", region: "Southeast", sport: .basketball),
        SportTeam(id: "nba-philadelphia", name: "Philadelphia 76ers", league: "NBA", region: "Atlantic", sport: .basketball),
        SportTeam(id: "nba-phoenix", name: "Phoenix Suns", league: "NBA", region: "Pacific", sport: .basketball),
        SportTeam(id: "nba-portland", name: "Portland Trail Blazers", league: "NBA", region: "Northwest", sport: .basketball),
        SportTeam(id: "nba-sacramento", name: "Sacramento Kings", league: "NBA", region: "Pacific", sport: .basketball),
        SportTeam(id: "nba-san-antonio", name: "San Antonio Spurs", league: "NBA", region: "Southwest", sport: .basketball),
        SportTeam(id: "nba-toronto", name: "Toronto Raptors", league: "NBA", region: "Atlantic", sport: .basketball),
        SportTeam(id: "nba-utah", name: "Utah Jazz", league: "NBA", region: "Northwest", sport: .basketball),
        SportTeam(id: "nba-washington", name: "Washington Wizards", league: "NBA", region: "Southeast", sport: .basketball),

        SportTeam(id: "nhl-anaheim", name: "Anaheim Ducks", league: "NHL", region: "Pacific", sport: .hockey),
        SportTeam(id: "nhl-boston", name: "Boston Bruins", league: "NHL", region: "Atlantic", sport: .hockey),
        SportTeam(id: "nhl-buffalo", name: "Buffalo Sabres", league: "NHL", region: "Atlantic", sport: .hockey),
        SportTeam(id: "nhl-calgary", name: "Calgary Flames", league: "NHL", region: "Pacific", sport: .hockey),
        SportTeam(id: "nhl-carolina", name: "Carolina Hurricanes", league: "NHL", region: "Metropolitan", sport: .hockey),
        SportTeam(id: "nhl-chicago", name: "Chicago Blackhawks", league: "NHL", region: "Central", sport: .hockey),
        SportTeam(id: "nhl-colorado", name: "Colorado Avalanche", league: "NHL", region: "Central", sport: .hockey),
        SportTeam(id: "nhl-columbus", name: "Columbus Blue Jackets", league: "NHL", region: "Metropolitan", sport: .hockey),
        SportTeam(id: "nhl-dallas", name: "Dallas Stars", league: "NHL", region: "Central", sport: .hockey),
        SportTeam(id: "nhl-detroit", name: "Detroit Red Wings", league: "NHL", region: "Atlantic", sport: .hockey),
        SportTeam(id: "nhl-edmonton", name: "Edmonton Oilers", league: "NHL", region: "Pacific", sport: .hockey),
        SportTeam(id: "nhl-florida", name: "Florida Panthers", league: "NHL", region: "Atlantic", sport: .hockey),
        SportTeam(id: "nhl-los-angeles", name: "Los Angeles Kings", league: "NHL", region: "Pacific", sport: .hockey),
        SportTeam(id: "nhl-minnesota", name: "Minnesota Wild", league: "NHL", region: "Central", sport: .hockey),
        SportTeam(id: "nhl-montreal", name: "Montreal Canadiens", league: "NHL", region: "Atlantic", sport: .hockey),
        SportTeam(id: "nhl-nashville", name: "Nashville Predators", league: "NHL", region: "Central", sport: .hockey),
        SportTeam(id: "nhl-new-jersey", name: "New Jersey Devils", league: "NHL", region: "Metropolitan", sport: .hockey),
        SportTeam(id: "nhl-islanders", name: "New York Islanders", league: "NHL", region: "Metropolitan", sport: .hockey),
        SportTeam(id: "nhl-rangers", name: "New York Rangers", league: "NHL", region: "Metropolitan", sport: .hockey),
        SportTeam(id: "nhl-ottawa", name: "Ottawa Senators", league: "NHL", region: "Atlantic", sport: .hockey),
        SportTeam(id: "nhl-philadelphia", name: "Philadelphia Flyers", league: "NHL", region: "Metropolitan", sport: .hockey),
        SportTeam(id: "nhl-pittsburgh", name: "Pittsburgh Penguins", league: "NHL", region: "Metropolitan", sport: .hockey),
        SportTeam(id: "nhl-san-jose", name: "San Jose Sharks", league: "NHL", region: "Pacific", sport: .hockey),
        SportTeam(id: "nhl-seattle", name: "Seattle Kraken", league: "NHL", region: "Pacific", sport: .hockey),
        SportTeam(id: "nhl-st-louis", name: "St. Louis Blues", league: "NHL", region: "Central", sport: .hockey),
        SportTeam(id: "nhl-tampa-bay", name: "Tampa Bay Lightning", league: "NHL", region: "Atlantic", sport: .hockey),
        SportTeam(id: "nhl-toronto", name: "Toronto Maple Leafs", league: "NHL", region: "Atlantic", sport: .hockey),
        SportTeam(id: "nhl-utah", name: "Utah Mammoth", league: "NHL", region: "Central", sport: .hockey),
        SportTeam(id: "nhl-vancouver", name: "Vancouver Canucks", league: "NHL", region: "Pacific", sport: .hockey),
        SportTeam(id: "nhl-vegas", name: "Vegas Golden Knights", league: "NHL", region: "Pacific", sport: .hockey),
        SportTeam(id: "nhl-washington", name: "Washington Capitals", league: "NHL", region: "Metropolitan", sport: .hockey),
        SportTeam(id: "nhl-winnipeg", name: "Winnipeg Jets", league: "NHL", region: "Central", sport: .hockey)
    ]
