...
enum L {
    ...
    private static func en(_ key: Key) -> String {
        ...
        case .onboardingBody: "RBT Varpa Rain is a complete local companion for the Swedish precision sport: history, rules, match planning, result logging, and kit notes in one app."
        case .onboardingButton: "Enter RBT Varpa Rain"
        ...
        case .localProfile: "RBT Varpa Rain local profile"
    ...
    private static func sv(_ key: Key) -> String {
        ...
        case .onboardingBody: "RBT Varpa Rain är en komplett lokal följeslagare för den svenska precisionssporten: historia, regler, matchplanering, resultatlogg och utrustningsanteckningar i samma app."
        case .onboardingButton: "Öppna RBT Varpa Rain"
        ...
        case .localProfile: "Lokal profil i RBT Varpa Rain"
