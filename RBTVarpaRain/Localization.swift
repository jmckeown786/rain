...
enum L {
    ...
    private static func en(_ key: Key) -> String {
        ...
        case .onboardingBody: "Varpa Match Journal is a complete local companion for the Swedish precision sport: history, rules, match planning, result logging, and kit notes in one app."
        case .onboardingButton: "Enter Varpa Match Journal"
        ...
        case .localProfile: "Varpa Match Journal local profile"
    ...
    private static func sv(_ key: Key) -> String {
        ...
        case .onboardingBody: "Varpa Match Journal är en komplett lokal följeslagare för den svenska precisionssporten: historia, regler, matchplanering, resultatlogg och utrustningsanteckningar i samma app."
        case .onboardingButton: "Öppna Varpa Match Journal"
        ...
        case .localProfile: "Lokal profil i Varpa Match Journal"
